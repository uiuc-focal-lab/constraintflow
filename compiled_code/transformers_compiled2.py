...
class deeppoly:
	...
	def Relu(self, abs_elem, prev, curr, poly_size, curr_size, prev_size, input_size, batch_size):
		...
		cse_var_68 = plus(cse_var_69, divide(mult(mult(cse_var_41, torch.tensor(minus(0.0, 1.0)).unsqueeze(0).unsqueeze(1).repeat(batch_size, curr_size)), cse_var_44), cse_var_33))
