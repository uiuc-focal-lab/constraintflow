...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\62\63\7Q\2\2\63\64\7%\2\2\64\65\5\30\r\2\65\66\7&\2")
        buf.write("\2\66\67\7)\2\2\678\5\36\20\289\7*\2\29:\7+\2\2:\5\3\2")
        buf.write("\2\2;<\b\4\1\2<=\7\5\2\2=>\7%\2\2>?\5,\27\2?@\7\26\2\2")
        buf.write("@A\5\36\20\2AB\7\26\2\2BC\5\36\20\2CD\7\26\2\2DE\7`\2")
        buf.write("\2EF\7&\2\2FG\7+\2\2GP\3\2\2\2HI\7R\2\2IJ\5\b\5\2JK\7")
        ...
        buf.write("\3\2\2\2XY\7`\2\2YZ\7%\2\2Z[\5\30\r\2[\\\7&\2\2\\\t\3")
        ...
        buf.write("pq\7`\2\2q\21\3\2\2\2rs\t\2\2\2s\23\3\2\2\2tu\5\36\20")
        ...
        buf.write("U\2\2\u00ac\u00eb\7T\2\2\u00ad\u00eb\7^\2\2\u00ae\u00eb")
        buf.write("\7_\2\2\u00af\u00eb\7`\2\2\u00b0\u00eb\7S\2\2\u00b1\u00eb")
        buf.write("\7V\2\2\u00b2\u00eb\7W\2\2\u00b3\u00eb\7X\2\2\u00b4\u00eb")
        buf.write("\7Y\2\2\u00b5\u00eb\7Z\2\2\u00b6\u00b7\7%\2\2\u00b7\u00b8")
        ...
        buf.write("\u00fe\7`\2\2\u00fe\u012c\7(\2\2\u00ff\u0100\f\16\2\2")
...
class dslParser ( Parser ):
    ...
    def operator(self):
        ...
        try:
            ...
            if not(((((_la - 60)) & ~0x3f) == 0 and ((1 << (_la - 60)) & ((1 << (dslParser.AFFINE - 60)) | (1 << (dslParser.RELU - 60)) | (1 << (dslParser.ABS - 60)) | (1 << (dslParser.HARDTANH - 60)) | (1 << (dslParser.MAXPOOL - 60)) | (1 << (dslParser.REVAFFINE - 60)) | (1 << (dslParser.NEURON_MULT - 60)) | (1 << (dslParser.NEURON_ADD - 60)) | (1 << (dslParser.NEURON_MAX - 60)) | (1 << (dslParser.NEURON_MIN - 60)) | (1 << (dslParser.NEURON_LIST_MULT - 60)) | (1 << (dslParser.REVRELU - 60)) | (1 << (dslParser.REVMAXPOOL - 60)) | (1 << (dslParser.REVNEURON_MULT - 60)) | (1 << (dslParser.REVNEURON_ADD - 60)) | (1 << (dslParser.REVNEURON_MAX - 60)) | (1 << (dslParser.REVNEURON_MIN - 60)))) != 0)):
