...
class dslVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by dslParser#ptop.
    def visitPtop(self, ctx:dslParser.PtopContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by dslParser#ptparen.
    def visitPtparen(self, ctx:dslParser.PtparenContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by dslParser#ptbasic.
    ...
    # Visit a parse tree produced by dslParser#propparen.
